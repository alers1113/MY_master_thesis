...
\begin{figure}[h]
    \begin{minipage}[h]{0.48\linewidth}
        \center{\includegraphics[width=1.1\linewidth]{Snow_Mass_R.png} \\ (а) }
    \end{minipage}
    \hfill
    \begin{minipage}[h]{0.51\linewidth}
        \center{\includegraphics[width=1.1\linewidth]{Snow_area_R.png} \\ (б) }
    \end{minipage}
\end{figure}
...
\begin{figure}[h]
    ...
    ~\\
    \\
        \center{\includegraphics[width=1\linewidth]{Snow_albedo_03_1997_cat.png} \\ Среднемесячное широкополосное альбедо заснеженной поверхности, рассчитанное с помощью построенной модели альбедо \\ (март 1997 г.)}
    \end{minipage}
    \begin{minipage}[h]{0.49\linewidth}
        \center{\includegraphics[width=1\linewidth]{Snow_albedo_reanalyses_03_ave.png} \\ Альбедо снега по данным реанализа CAMS, осредненное за 2003--2019 годы \\ (месяц -- март)}
    \end{minipage}
\end{figure}
